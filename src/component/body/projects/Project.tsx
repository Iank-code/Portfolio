    ...
    <div className="project">
      ...
      <div className="projects-container">
        <div className="project-info">
          ...
          <p>
            Cloud storage is a very popular storage solution in the modern time.
            <br />
            It provides an easy way for one <br /> to organize their files in an
            accessible manner.
            <br />
          ...
          <div style={{
            ...
            <a href="https://moringa-box.vercel.app/" target="_blank">Live</a>
          </div>
        </div>
        <iframe
